...
CREATE TABLE IF NOT EXISTS `datagenerated_accountnumbers` (
  ...
  UNIQUE INDEX `IDX_UC_datagenerated_accountnumbers` (`AccountNumberValue` ASC, `RegisteredApp` ASC) VISIBLE,
  ...
  INDEX `IDX_DataGenerated_AccountNumbers` (`AccountNumbersID` ASC, `AccountNumberValue` ASC, `CreatedDate` ASC, `StatusID` ASC, `CreatedUser` ASC, `RegisteredApp` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `datagenerated_addresses` (
  ...
  UNIQUE INDEX `IDX_UC_DataGenerated_Addresses` (`AddressStreet` ASC, `AddressStreet2` ASC, `RegisteredApp` ASC) VISIBLE,
  ...
  INDEX `IDX_DataGenerated_Addresses` (`AddressID` ASC, `AddressStreet` ASC, `AddressStreet2` ASC, `AddressFormatTypeId` ASC, `StatusID` ASC, `CreatedDate` ASC, `CreatedUser` ASC, `RegisteredApp` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `datagenerated_creditcard` (
  ...
  UNIQUE INDEX `IDX_UC_datagenerated_creditcard` (`CreditCardName` ASC, `CreditCardNumber` ASC, `RegisteredApp` ASC) VISIBLE,
  ...
  INDEX `IDX_DataGenerated_CreditCard` (`CreditCardID` ASC, `CreditCardNumber` ASC, `CreditCardName` ASC, `CreatedDate` ASC, `StatusID` ASC, `CreatedUser` ASC, `RegisteredApp` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `datagenerated_driverslicenses` (
  ...
  UNIQUE INDEX `IDX_UC_DataGenerated_DriversLicenses` (`DLN` ASC, `StateCode` ASC, `CompleteDriversLicenseNumber` ASC, `RegisteredApp` ASC) VISIBLE,
  ...
  INDEX `IDX_DataGenerated_DriversLicenses` (`DriversLicensesID` ASC, `CreatedDate` ASC, `DLN` ASC, `StateCode` ASC, `StatusID` ASC, `CompleteDriversLicenseNumber` ASC, `CreatedUser` ASC, `RegisteredApp` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `datagenerated_useridentities` (
  ...
  UNIQUE INDEX `IDX_UC_DataGenerated_UserIdentities` (`UserIdentityValue` ASC, `UserDomain` ASC, `RegisteredApp` ASC) VISIBLE,
  ...
  INDEX `IDX_DataGenerated_Identities` (`UserIdentitiesID` ASC, `UserIdentityValue` ASC, `UserDomain` ASC, `CreatedDate` ASC, `StatusID` ASC, `AdditionalAttributes` ASC, `RegisteredApp` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `platform_appsettings_dataattributes` ;

create table if not exists platform_appsettings_dataattributes
(
	AppSettingsDataAttributeID smallint auto_increment
		primary key,
	PlatformDataAttributeID smallint null,
	ServiceClassName varchar(75) null,
	CodeBaseLang varchar(20) null,
	CreatedDate datetime default CURRENT_TIMESTAMP null,
	StatusID smallint default 1 null,
	MaxTableTransactionCount bigint null,
	CurrentTableTransactionCount bigint null,
	CurrentTableTransactionCounRunDateTime datetime null,
	...
	constraint FK_platform_appsettings_dataattributes_dataattributes
		foreign key (PlatformDataAttributeID) references platform_dataattributes (PlatformDataAttributesID),
...
CREATE TABLE `platform_config_datagen` (
  ...
  `DataGenTypeID` varchar(10) DEFAULT NULL,
  ...
  KEY `IDX_PlatformConfigDataGen` (`DataGenConfigID`,`DataAttributeID`,`DataTypeGenConfigName`,`RunQuantity`,`MinuteInterval`,`SpecialInstructions`,`CreatedDate`,`CreatedUser`,`StatusID`,`ApplicationID`),
  ...
  CONSTRAINT `FK_platform_config_datagen_registeredapp` FOREIGN KEY (`ApplicationID`) REFERENCES `refdata_application` (`AppGUID`)) 
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `refdata_codesettomsgtype` ;
...
CREATE TABLE `refdata_datagentypes` (
  ...
  KEY `IDX_RefData_DataGenTypes` (`DataGenTypeID`,`DataGenTypeDescription`,`CreatedDate`,`StatusID`,`CreatedUser`),
  CONSTRAINT `FK_RefDataDataGenTypes_Status` FOREIGN KEY (`StatusID`) 
  REFERENCES `refdata_status` (`StatusID`)) 
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
CREATE TABLE IF NOT EXISTS `refdata_industrystd_segments` (
  ...
  INDEX `IDX_IndustryStd_Segments` (`SegmentToIndustryID` ASC, `IndustryStd` ASC, `IndustryStdDesc` ASC, `CreatedDate` ASC, `StatusID` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `terms_codesetmetadata`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `terms_codesetmetadata` ;

CREATE TABLE IF NOT EXISTS `terms_codesetmetadata` (
